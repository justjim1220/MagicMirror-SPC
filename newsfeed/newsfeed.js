...
Module.register("newsfeed", {
    ...
    defaults: {
        feeds: [
            {
                title: "Kansas City Chief's News: ",
                url: "https://247sports.com/nfl/kansas-city-chiefs/Institution/Kansas-City-Chiefs-24549/Feeds",
                encoding: "UTF-8"
            },
            {
                title: "Bethany, Missouri Breaking News: ",
                url: "https://www.bethanyclipper.com/category/breaking/feed/",
                encoding: "UTF-8" //ISO-8859-1
            },
            {
                title: "Bethany, Missouri News & Rumors: ",
                url: "https://www.bethanyclipper.com/feed/",
                encoding: "UTF-8" //ISO-8859-1
            }
        ],
        ...
        updateInterval: 90 * 1000,      // every 90 seconds
    ...
    getDom: function () {
        ...
        if (this.config.feedUrl) {
            wrapper.className = "bold large normal";
        ...
        if (this.newsItems.length > 0) {
            ...
            if (!this.config.showDescription) {
                ...
                title.className = "bright large light" + (!this.config.wrapTitle ? " no-wrap" : " ");
            ...
            if (this.config.showDescription) {
                ...
                description.setAttribute("style", "padding-bottom:25px");
                description.className = "bright large bold" + (!this.config.wrapDescription ? " no-wrap" : "");
                description.innerHTML = this.newsItems[this.activeItem].sourceTitle + "&nbsp;" + moment(new Date(this.newsItems[this.activeItem].pubdate)).fromNow() + ": &nbsp;";                
                ...
                txtDesc.innerHTML = this.newsItems[this.activeItem].description;
